...
typedef enum
{
    ...
    XILA_GRAPHICS_COLOR_FORMAT_ARGB8565 = 0x13, /**< Not supported by sw renderer yet. */
    XILA_GRAPHICS_COLOR_FORMAT_RGB565A8 = 0x14, /**< Color array followed by Alpha array*/
    ...
    XILA_GRAPHICS_COLOR_FORMAT_I420 = XILA_GRAPHICS_COLOR_FORMAT_YUV_START, /*YUV420 planar(3 plane)*/
    ...
    XILA_GRAPHICS_COLOR_FORMAT_NV21 = 0x24,                                 /*YUV420 planar(2 plane), UV plane in 'V, U, V, U'*/
    XILA_GRAPHICS_COLOR_FORMAT_NV12 = 0x25,                                 /*YUV420 planar(2 plane), UV plane in 'U, V, U, V'*/
...
typedef enum
{
    ...
    XILA_GRAPHICS_FLEX_FLOW_ROW_WRAP = XILA_GRAPHICS_FLEX_FLOW_ROW | XILA_GRAPHICS_FLEX_WRAP,
    XILA_GRAPHICS_FLEX_FLOW_ROW_REVERSE = XILA_GRAPHICS_FLEX_FLOW_ROW | XILA_GRAPHICS_FLEX_REVERSE,
    XILA_GRAPHICS_FLEX_FLOW_ROW_WRAP_REVERSE = XILA_GRAPHICS_FLEX_FLOW_ROW | XILA_GRAPHICS_FLEX_WRAP | XILA_GRAPHICS_FLEX_REVERSE,
    XILA_GRAPHICS_FLEX_FLOW_COLUMN_WRAP = XILA_GRAPHICS_FLEX_FLOW_COLUMN | XILA_GRAPHICS_FLEX_WRAP,
    XILA_GRAPHICS_FLEX_FLOW_COLUMN_REVERSE = XILA_GRAPHICS_FLEX_FLOW_COLUMN | XILA_GRAPHICS_FLEX_REVERSE,
    XILA_GRAPHICS_FLEX_FLOW_COLUMN_WRAP_REVERSE = XILA_GRAPHICS_FLEX_FLOW_COLUMN | XILA_GRAPHICS_FLEX_WRAP | XILA_GRAPHICS_FLEX_REVERSE,
} Xila_graphics_flex_flow_t;

typedef enum
{
    XILA_GRAPHICS_GRAD_DIR_NONE,    /**< No gradient (the `grad_color` property is ignored)*/
    ...
    XILA_GRAPHICS_GRAD_DIR_LINEAR,  /**< Linear gradient defined by start and end points. Can be at any angle.*/
    XILA_GRAPHICS_GRAD_DIR_RADIAL,  /**< Radial gradient defined by start and end circles*/
    XILA_GRAPHICS_GRAD_DIR_CONICAL, /**< Conical gradient defined by center point, start and end angles*/
...
typedef enum
{
    XILA_GRAPHICS_BLEND_MODE_NORMAL,      /**< Simply mix according to the opacity value*/
    XILA_GRAPHICS_BLEND_MODE_ADDITIVE,    /**< Add the respective color channels*/
    XILA_GRAPHICS_BLEND_MODE_SUBTRACTIVE, /**< Subtract the foreground from the background*/
    XILA_GRAPHICS_BLEND_MODE_MULTIPLY,    /**< Multiply the foreground and background*/
...
typedef enum
{
    ...
    XILA_GRAPHICS_BORDER_SIDE_INTERNAL = 0x10, /**< FOR matrix-like objects (e.g. Button matrix)*/
...
typedef enum
{
    XILA_GRAPHICS_STYLE_STATE_CMP_SAME,          /**< The style properties in the 2 states are identical */
    XILA_GRAPHICS_STYLE_STATE_CMP_DIFF_REDRAW,   /**< The differences can be shown with a simple redraw */
    XILA_GRAPHICS_STYLE_STATE_CMP_DIFF_DRAW_PAD, /**< The differences can be shown with a simple redraw */
    XILA_GRAPHICS_STYLE_STATE_CMP_DIFF_LAYOUT,   /**< The differences can be shown with a simple redraw */
...
typedef enum
{
    ...
    XILA_GRAPHICS_CHART_TYPE_SCATTER, /**< Draw points and lines in 2D (x,y coordinates)*/
} lv_chart_type_t;
...
typedef enum
{
    ...
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_NO_REPEAT = 0x0020,  /**< Do not repeat press this button.*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_DISABLED = 0x0040,   /**< Disable this button.*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_CHECKABLE = 0x0080,  /**< The button can be toggled.*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_CHECKED = 0x0100,    /**< Button is currently toggled (e.g. checked).*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_CLICK_TRIG = 0x0200, /**< 1: Send XILA_GRAPHICS_EVENT_VALUE_CHANGE on CLICK, 0: Send XILA_GRAPHICS_EVENT_VALUE_CHANGE on PRESS*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_POPOVER = 0x0400,    /**< Show a popover when pressing this key*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_RESERVED_1 = 0x0800, /**< Reserved for later use*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_RESERVED_2 = 0x1000, /**< Reserved for later use*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_RESERVED_3 = 0x2000, /**< Reserved for later use*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_CUSTOM_1 = 0x4000,   /**< Custom free to use flag*/
    XILA_GRAPHICS_BUTTONMATRIX_CTRL_CUSTOM_2 = 0x8000,   /**< Custom free to use flag*/
...
typedef enum
{
    ...
    XILA_GRAPHICS_MENU_HEADER_TOP_UNFIXED, /**< Header is positioned at the top and can be scrolled out of view*/
...
typedef enum
{
    XILA_GRAPHICS_ROLLER_MODE_NORMAL,   /**< Normal mode (roller ends at the end of the options). */
    XILA_GRAPHICS_ROLLER_MODE_INFINITE, /**< Infinite mode (roller can be scrolled forever). */
...
typedef enum
{
    XILA_GRAPHICS_RESULT_INVALID = 0, /*Typically indicates that the object is deleted (become invalid) in the action
...
enum
{
    ...
    XILA_GRAPHICS_STATE_ANY = 0xFFFF, /**< Special value can be used in some functions to target all states*/
};
...
enum
{
    ...
    XILA_GRAPHICS_PART_INDICATOR = 0x020000, /**< Indicator, e.g. for slider, bar, switch, or the tick box of the checkbox*/
    XILA_GRAPHICS_PART_KNOB = 0x030000,      /**< Like handle to grab to adjust the value*/
    XILA_GRAPHICS_PART_SELECTED = 0x040000,  /**< Indicate the currently selected option or section*/
    XILA_GRAPHICS_PART_ITEMS = 0x050000,     /**< Used if the widget has multiple similar elements (e.g. table cells)*/
    XILA_GRAPHICS_PART_CURSOR = 0x060000,    /**< Mark a specific place e.g. for text area's cursor or on a chart*/

    XILA_GRAPHICS_PART_CUSTOM_FIRST = 0x080000, /**< Extension point for custom widgets*/

    XILA_GRAPHICS_PART_ANY = 0x0F0000, /**< Special value can be used in some functions to target all parts*/
};
...
typedef enum
{
    ...
    XILA_GRAPHICS_TEXT_FLAG_EXPAND = 0x01,    /**< Ignore max-width to avoid automatic word wrapping*/
    XILA_GRAPHICS_TEXT_FLAG_FIT = 0x02,       /**< Max-width is already equal to the longest line. (Used to skip some calculation)*/
    XILA_GRAPHICS_TEXT_FLAG_BREAK_ALL = 0x04, /**< To prevent overflow, insert breaks between any two characters.
                                        Otherwise breaks are inserted at word boundaries, as configured via XILA_GRAPHICS_TXT_BREAK_CHARS
                                        or according to XILA_GRAPHICS_TXT_LINE_BREAK_LONG_LEN, XILA_GRAPHICS_TXT_LINE_BREAK_LONG_PRE_MIN_LEN,
                                        and XILA_GRAPHICS_TXT_LINE_BREAK_LONG_POST_MIN_LEN.*/
...
typedef enum
{
    ...
    XILA_GRAPHICS_SCROLLBAR_MODE_ACTIVE, /**< Show scroll bars when object is being scrolled*/
    XILA_GRAPHICS_SCROLLBAR_MODE_AUTO,   /**< Show scroll bars when the content is large enough to be scrolled*/
...
typedef enum
{
    ...
    XILA_GRAPHICS_SPAN_MODE_BREAK,  /**< Keep width, break the too long lines and expand height */
